...
$mail->addAddress('info@bisnisbermentor.com', $request->name);
$mail->isHTML(true);  //set email format to HTML
$mail->Subject  = $request->subject;
$mail->Body     = '<table><tr><td>Nama Lengkap</td><td>:</td><td>'.$request->name.'</td></tr><tr><td>Email Pengirim</td><td>:</td><td>'.$request->email.'</td></tr><tr><td>Pesan Pengirim</td><td>:</td><td>'.$request->message.'</td></tr></table>';
if(!$mail->send()) {
